...
class HistorySaveFoodPage extends StatefulWidget {
  const HistorySaveFoodPage({Key? key}) : super(key: key);

  @override
  State<HistorySaveFoodPage> createState() => _HistorySaveFoodPageState();
}

class _HistorySaveFoodPageState extends State<HistorySaveFoodPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('History Save Food'),
      ),
